...
const PRE_IMAGES = [
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.32 (1).jpeg"),
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.32 (2).jpeg"),
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.32.jpeg"),
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.36.jpeg"),
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.37 (1).jpeg"),
  preImagePath("WhatsApp Image 2026-08-14 at 20.52.37.jpeg"),
];
...
export default function WeddingInvitation() {
  ...
  const submitToGoogleSheet = async (payload: Record<string, string>) => {
    ...
    // In no-cors mode, response is opaque, so we can't check response.ok
              ...
              <>
                ...
                >
                  ...
                  <div className="flex flex-col items-center w-full max-w-xl mx-auto gap-4 md:gap-8">
                    ...
                    >
                      {INVITATION.couple.groom} <span className="text-3xl md:text-5xl opacity-90 italic mx-1 md:mx-3">&</span> {INVITATION.couple.bride}
                    </motion.p>
                  </div>
                </motion.div>
                  ...
                  <div className="text-[#c5a059] space-y-6 max-w-3xl mx-auto leading-relaxed text-base md:text-lg">
                    {guestName && (
                      <div className="mb-12 text-center">
                        <h2 className="text-2xl md:text-3xl font-bold text-[#d4af37] mb-3">{guestName}</h2>
                        <p className="text-slate-700 font-medium">අපගේ විවාහ මංගල්‍යයට {guestSuffix} ආදරයෙන් ආරාධනා කර සිටිමු.</p>
                      </div>
                    )}
              ...
              <div className="container mx-auto px-6 max-w-5xl text-center">
                ...
                >
                  ...
                  <div className="pt-12 flex flex-col gap-3">
                    ...
                    <p className="text-[#c5a059]/70 text-xs font-sans tracking-wide">
                      Want a beautiful wedding website like this? Create yours with <a target="_blank" rel="noreferrer" className="text-[#d4af37] hover:text-white underline transition-colors" href="https://wa.me/94707819074">invitemint</a>
                    </p>
                  </div>
                </motion.div>
              </div>
